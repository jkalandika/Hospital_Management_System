...
if(isset($_POST['submit'])){
    ...
    $sql_quary = "INSERT INTO `appointment` (`pname`, `id`,  `dname`, `Aday`)
    VALUES ('$pname', '0', '$dname', '$Aday');";
    ...
    <ul class="navbar">
      <li><a href="index.php">Home</a></li>
       ...
       <li><a href="channeling.html">Channeling</a></li>
        <li><a href="contact.php"class="active">Appointment</a></li>
    ...
    <section class="contact us " id="contact">   
      ...
      <div class="form">
        <div class="contact-info">
          ...
          <p class="text">
          Call us regarding any inquiry...<br>We Are Always with You</p><br><br>
        ...
        <div class="contact-form">
          ...
          <form action="" method="POST" autocomplete="off">
            ...
            <div class="input-container_con">
              <input type="text" name="pname" class="input" placeholder="Ashen_68" />
            </div>
              <label for="">Doctor name:</label>
            <div class="input-container_con">
              <input type="text" name="dname" class="input" placeholder="youremail@gmail.com" required/>
            </div>
              <label for="">Date:</label>
            <div class="input-container_con">
            <input type="date" name="Aday"  placeholder="DD/MM/YYYY" required>
            </div>
